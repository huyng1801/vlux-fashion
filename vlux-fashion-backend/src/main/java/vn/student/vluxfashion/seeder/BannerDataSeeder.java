    ...
    CommandLineRunner seedBanners(BannerRepository bannerRepository) {
        return args -> {
            if (bannerRepository.count() == 0) { // To prevent duplicate entries
                ...
                banner1.setImageUrl("https://huyngaws.s3.ap-southeast-2.amazonaws.com/banner/360_F_367567354_JnT96QOWu8rugfLdYaESxWkqaIOUja8t.jpg");
                ...
                banner2.setImageUrl("https://huyngaws.s3.ap-southeast-2.amazonaws.com/banner/360_F_367567354_JnT96QOWu8rugfLdYaESxWkqaIOUja8t.jpg");
